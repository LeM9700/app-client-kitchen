...
//
// [POC] Normalement exclu par .gitignore (`*.g.dart`) comme tout output
// build_runner — force-commité ici (`git add -f`) car json_serializable ne
// le régénère pas dans cet environnement (voir docs/openapi-codegen.md,
// section "Point ouvert connu"). Écrit à la main mais mécaniquement
// équivalent à ce que json_serializable produirait. À supprimer et
// régénérer normalement une fois le problème résolu.
...
FavoriteCreate _$FavoriteCreateFromJson(Map<String, dynamic> json) =>
    FavoriteCreate(productId: (json['product_id'] as num).toInt());
...
HTTPValidationError _$HTTPValidationErrorFromJson(
